  ...
  return (
    ...
    >
      ...
      <Box sx={{ mb: 4 }}>
        ...
        >
          All your thoughtful responses in one place
        </Typography>
      </Box>
      ...
      <Stack spacing={3}>
        {user?.user?.replies?.length > 0 ? (
          ...
          >
            ...
            >
              Your thoughtful responses to community posts will appear here. Start engaging with posts to build meaningful conversations! 
            </Typography>
          </Box>
        )}
      </Stack>
