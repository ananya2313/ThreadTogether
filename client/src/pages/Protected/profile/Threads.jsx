  ...
  return (
    ...
    >
      ...
      <Box sx={{ mb: 4 }}>
        ...
        >
          Your original posts and conversations
        </Typography>
      </Box>
      ...
      <Stack spacing={3}>
        {user?.user?.threads?.length > 0 ? (
          ...
          >
            ...
            >
              Start weaving your story! Share your thoughts, ideas, and experiences to connect with the peaceful ThreadTogether community.
            </Typography>
          </Box>
        )}
      </Stack>
